...
function fetchInterstitial() {
  console.log("fetchInterstitial() for " + document.URL)
  ...
  $.get(url, function(responseText) {
    ...
    interstitial_url = response['interstitial_url'] || null
    commit_message = response['commit_message'] || null
    updateDocument()
  });
}
...
function pageChangedCallback() {
  if (!/https?:\/\/github\.com\/.+\/.+\/pull\/\d+$/.test(document.URL)) {
